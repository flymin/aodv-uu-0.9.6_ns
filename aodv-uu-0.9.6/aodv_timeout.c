...
void NS_CLASS route_expire_timeout(void *arg)
{
	...
	if (rt->hcnt == 1)	//һ��,��Ϊ���ھӽڵ�·��,�����ھ�����break����
		//�ھӽڵ�Ķ��ѻ��������·�ɵ�ʧЧ,����rerr��Ϣ
		neighbor_link_break(rt);
	else {				//����,����Ҫ��������ǰ���ڵ�
		rt_table_invalidate(rt);		//
		precursor_list_destroy(rt);		//ɾ��ǰ���ڵ�����,�ͷſռ�
	}
 ...
 * hello�ĵȴ���ʱ,����Լ�����ڽڵ�ᶨʱ����hello��Ϣ
 * ������һ��ʱ��δ�յ�hello��Ϣ������Ϊ���ڽڵ�����ӳ���������*/
